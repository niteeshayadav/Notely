  ...
  return (
    <div className="bg-[#EAE0D5] p-5 rounded-xl shadow-lg hover:shadow-2xl transition-all border border-gray-200 flex flex-col h-full">
      ...
      <div className="mt-4 flex gap-2 justify-end">
        <button  onClick={onEdit} className="text-blue-600 hover:text-blue-800 text-xs font-bold">Edit</button>
        <button onClick={onDelete} className="text-red-600 hover:text-red-800 text-xs font-bold">Delete</button>
      </div>
    </div>
  )
}
